...
const ValidateInputGeneric = ({invalid, message, ...props}) => {
    ...
    return (
        <Fragment>
            <div style={{display: 'inline-flex', width: 'auto', position: 'relative'}} className="innerIconContainer">
                {invalid && message ?
...
ValidateInputGeneric.propTypes = {
    invalid: PropTypes.bool,
    message: PropTypes.string,
    children: PropTypes.element,
};

export default ValidateInputGeneric;
